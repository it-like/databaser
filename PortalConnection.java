...
public class PortalConnection {
    ...
    public String getInfo(String student) throws SQLException{
        ...
        try(PreparedStatement st = conn.prepareStatement(
          ...
          "'seminarCourses', (SELECT COUNT(PassedCourses.course) AS sumSeminars FROM PassedCourses, Classified WHERE PassedCourses.course = Classified.code AND Classified.classification LIKE 'seminar' AND PassedCourses.student = BasicInformation.idnr), " +
